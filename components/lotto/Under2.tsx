...
const Under2 = ({ gameMode, gameId, prizes, setGameMode, visibleNumbers = [], maxStake }: Props) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <Button
            ...
            size="lg"
            onClick={placeBet}
            disabled={selectedNumbers.length !== 2 || betAmount <= 0 || isPlacingBet}
            className="w-full py-3"
          >
            {isPlacingBet ? "Placing..." : "Stake"}
          </Button>

          {(selectedNumbers.length !== 2 || betAmount <= 0) && (
            <div className="text-xs text-red-400 text-left list-disc ml-4">
              {selectedNumbers.length !== 2 && <li>Select exactly 2 numbers</li>}
